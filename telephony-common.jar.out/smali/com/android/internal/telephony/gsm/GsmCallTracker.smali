...
.method constructor <init>(Lcom/android/internal/telephony/gsm/GSMPhone;)V
    ...
    .line 125
    iput-object v5, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->emergencyCatJPN:Ljava/lang/String;
...
.method private updatePhoneState()V
    ...
    iput-object v2, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->state:Lcom/android/internal/telephony/PhoneConstants$State;
...
.method declared-synchronized dial(Ljava/lang/String;ILcom/android/internal/telephony/UUSInfo;Lcom/android/internal/telephony/Call$CallType;)Lcom/android/internal/telephony/Connection;
    ...
    .line 264
    .local v7, isDialRequestPending:Z
    ...
    .line 259
    .end local v7           #isDialRequestPending:Z
    :catchall_0
    move-exception v0
    ...
    .line 316
    .restart local v7       #isDialRequestPending:Z
    :cond_0
    :try_start_1
    iget-object v0, p0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->foregroundCall:Lcom/android/internal/telephony/gsm/GsmCall;
    ...
    const-string v2, "dial emergencyCat : "
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    :sswitch_1
    const-string v1, "EVENT_HANGUP_FG_RESUME_BG_RESULT"
    ...
    .line 1369
    const-string v1, "handle EVENT_HANGUP_FG_RESUME_BG_RESULT"
    ...
    invoke-virtual {v0, v1}, Lcom/android/internal/telephony/gsm/GsmCallTracker;->dialPendingCall(I)V
    ...
    .end local v9           #ar:Landroid/os/AsyncResult;
    :sswitch_3
    const-string v1, "[EVENT_SWITCH_RESULT]"
    ...
    iput-boolean v1, v0, Lcom/android/internal/telephony/gsm/GsmCallTracker;->callSwitchPending:Z
    ...
    const-string v2, "handle EVENT_SWITCH_RESULTF - exception:"
...
.method protected declared-synchronized handlePollCalls(Landroid/os/AsyncResult;)V
    ...
    check-cast v15, Lcom/android/internal/telephony/DriverCall;

    .line 761
    .restart local v15       #dc:Lcom/android/internal/telephony/DriverCall;
    iget v2, v15, Lcom/android/internal/telephony/DriverCall;->index:I
    ...
    .line 774
    .local v14, currState:Lcom/android/internal/telephony/Call$State;
    ...
    invoke-static {v2, v3}, Lcom/android/internal/telephony/CallStateBroadcaster;->SendCallStatus(Ljava/lang/String;Lcom/android/internal/telephony/Call$State;)V

    .line 779
    .end local v14           #currState:Lcom/android/internal/telephony/Call$State;
    :cond_1
    new-instance v2, Ljava/lang/StringBuilder;
    ...
    invoke-virtual {v2, v15}, Lcom/android/internal/telephony/gsm/GsmConnection;->compareTo(Lcom/android/internal/telephony/DriverCall;)Z
    ...
    invoke-virtual {v2, v15}, Lcom/android/internal/telephony/gsm/GsmConnection;->update(Lcom/android/internal/telephony/DriverCall;)Z
    ...
    .line 809
    .local v17, ex:Lcom/android/internal/telephony/CallStateException;
    :try_start_3
    const-string v2, "GSM"
    ...
    .line 817
    .end local v17           #ex:Lcom/android/internal/telephony/CallStateException;
    :cond_6
    move-object/from16 v0, p0
    ...
    invoke-direct {v3, v4, v15, v0, v1}, Lcom/android/internal/telephony/gsm/GsmConnection;-><init>(Landroid/content/Context;Lcom/android/internal/telephony/DriverCall;Lcom/android/internal/telephony/gsm/GsmCallTracker;I)V
    ...
    .line 833
    iget-object v2, v15, Lcom/android/internal/telephony/DriverCall;->state:Lcom/android/internal/telephony/DriverCall$State;
    ...
    invoke-virtual {v2}, Lcom/android/internal/telephony/gsm/GsmConnection;->onConnectedInOrOut()V
    ...
    invoke-virtual {v2}, Lcom/android/internal/telephony/gsm/GsmConnection;->onStartedHolding()V
    ...
    invoke-virtual {v12, v15}, Lcom/android/internal/telephony/gsm/GsmConnection;->compareTo(Lcom/android/internal/telephony/DriverCall;)Z
    ...
    .line 892
    invoke-virtual {v12, v15}, Lcom/android/internal/telephony/gsm/GsmConnection;->update(Lcom/android/internal/telephony/DriverCall;)Z
    ...
    .line 922
    .local v23, state:Lcom/android/internal/telephony/Call$State;
    sget-object v2, Lcom/android/internal/telephony/Call$State;->ALERTING:Lcom/android/internal/telephony/Call$State;
    ...
    .end local v12           #conn:Lcom/android/internal/telephony/gsm/GsmConnection;
    .end local v15           #dc:Lcom/android/internal/telephony/DriverCall;
    .end local v23           #state:Lcom/android/internal/telephony/Call$State;
    :cond_17
    move-object/from16 v0, p0
