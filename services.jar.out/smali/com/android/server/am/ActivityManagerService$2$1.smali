...
.method public run()V
    ...
    .line 1544
    const-string v2, "------ MEMORY INFO (/proc/meminfo) ------"
    ...
    invoke-virtual {v2, v3, v0}, Lcom/android/server/am/ActivityManagerService;->dumpKernelMemoryUsage(Ljava/lang/String;Ljava/lang/StringBuilder;)V
    ...
    .line 1547
    const-string v2, "------ BUDDYINFO (/proc/buddyinfo) ------"
    ...
    const-string v3, "/proc/buddyinfo"
    ...
    .line 1550
    const-string v2, "------ ION EXYNOS CONTIG HEAP INFO (/sys/kernel/debug/ion/exynos_contig_heap) ------"
    ...
    const-string v3, "/sys/kernel/debug/ion/exynos_contig_heap"
    ...
    .line 1553
    const-string v2, "------ ION EXYNOS NONCONTIG HEAP INFO (/sys/kernel/debug/ion/exynos_noncontig_heap) ------"
    ...
    const-string v3, "/sys/kernel/debug/ion/exynos_noncontig_heap"
    ...
    .line 1556
    const-string v2, "------ ION CONTIG HEAP INFO (/sys/kernel/debug/ion/ion_contig_heap) ------"
    ...
    const-string v3, "/sys/kernel/debug/ion/ion_contig_heap"
    ...
    .line 1559
    const-string v2, "------ ION NONCONTIG HEAP INFO (/sys/kernel/debug/ion/ion_noncontig_heap) ------"
    ...
    const-string v3, "/sys/kernel/debug/ion/ion_noncontig_heap"
    ...
    .line 1562
    const-string v2, "------ LMK COUNT (/sys/module/lowmemorykiller/parameters/lmkcount) ------"
