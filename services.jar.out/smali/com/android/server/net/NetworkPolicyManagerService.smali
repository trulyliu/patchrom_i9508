...
.method private enqueueRestrictedNotification(Ljava/lang/String;)V
    ...
    .line 876
    .local v17, rp:Landroid/app/enterprise/RestrictionPolicy;
    if-eqz v17, :cond_2

    invoke-virtual/range {v17 .. v17}, Landroid/app/enterprise/RestrictionPolicy;->isBackgroundDataEnabled()Z
    ...
    .line 879
    .local v18, tele:Landroid/telephony/TelephonyManager;
    move-object/from16 v0, p0
    ...
    .line 880
    .local v13, isAirplaneMode:Z
    :goto_0
    const/4 v14, 0x1

    .line 886
    .local v14, isMobileData:Z
    const/4 v1, 0x0
    ...
    .line 935
    .end local v10           #conn:Landroid/net/ConnectivityManager;
    .end local v13           #isAirplaneMode:Z
    .end local v14           #isMobileData:Z
    .end local v17           #rp:Landroid/app/enterprise/RestrictionPolicy;
    .end local v18           #tele:Landroid/telephony/TelephonyManager;
    :goto_2
    return-void

    .line 879
    .restart local v10       #conn:Landroid/net/ConnectivityManager;
    .restart local v17       #rp:Landroid/app/enterprise/RestrictionPolicy;
    .restart local v18       #tele:Landroid/telephony/TelephonyManager;
    :cond_0
    const/4 v13, 0x0
    ...
    .line 886
    .restart local v13       #isAirplaneMode:Z
    .restart local v14       #isMobileData:Z
    :cond_1
    const/4 v14, 0x0
    ...
    .line 913
    .local v15, mPhone:Landroid/telephony/TelephonyManager;
    const-string v1, "LGT"
    ...
    const-string v1, "android.settings.GLOBAL_ROAMING_LGT"
...
.method private writePolicyLocked()V
    ...
    invoke-static {v6, v12, v13}, Lcom/android/server/net/NetworkPolicyManagerService$XmlUtils;->writeIntAttribute(Lorg/xmlpull/v1/XmlSerializer;Ljava/lang/String;I)V
    ...
    invoke-static {v6, v12, v13}, Lcom/android/server/net/NetworkPolicyManagerService$XmlUtils;->writeBooleanAttribute(Lorg/xmlpull/v1/XmlSerializer;Ljava/lang/String;Z)V
    ...
    invoke-static {v6, v12, v13, v14}, Lcom/android/server/net/NetworkPolicyManagerService$XmlUtils;->writeLongAttribute(Lorg/xmlpull/v1/XmlSerializer;Ljava/lang/String;J)V
    ...
    invoke-static {v6, v12, v11}, Lcom/android/server/net/NetworkPolicyManagerService$XmlUtils;->writeIntAttribute(Lorg/xmlpull/v1/XmlSerializer;Ljava/lang/String;I)V

    .line 1471
    const-string v12, "policy"

    invoke-static {v6, v12, v7}, Lcom/android/server/net/NetworkPolicyManagerService$XmlUtils;->writeIntAttribute(Lorg/xmlpull/v1/XmlSerializer;Ljava/lang/String;I)V
