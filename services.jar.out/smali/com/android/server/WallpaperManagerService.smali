...
.method private saveSettingsLocked(Lcom/android/server/WallpaperManagerService$WallpaperData;Z)V
    .locals 12
    .parameter "wallpaper"
    .parameter "checkWallpaper"

    .prologue
    .line 1192
    iget v9, p1, Lcom/android/server/WallpaperManagerService$WallpaperData;->userId:I

    invoke-static {v9}, Lcom/android/server/WallpaperManagerService;->makeJournaledFile(I)Lcom/android/internal/util/JournaledFile;
    ...
    invoke-interface {v4, v7, v9}, Lorg/xmlpull/v1/XmlSerializer;->setOutput(Ljava/io/OutputStream;Ljava/lang/String;)V
    ...
    iget v11, p1, Lcom/android/server/WallpaperManagerService$WallpaperData;->width:I
    ...
    iget v11, p1, Lcom/android/server/WallpaperManagerService$WallpaperData;->height:I
    ...
    iget-object v11, p1, Lcom/android/server/WallpaperManagerService$WallpaperData;->name:Ljava/lang/String;
    ...
    sget-object v10, Lcom/android/server/WallpaperManagerService;->IMAGE_WALLPAPER:Landroid/content/ComponentName;
    ...
    iget-object v11, p1, Lcom/android/server/WallpaperManagerService$WallpaperData;->wallpaperComponent:Landroid/content/ComponentName;
    ...
    .line 1235
    .local v8, wallpaper_image:Ljava/io/File;
    ...
    const-string v11, "saveSettingsLocked - liveWallpaper : "
    ...
    const-string v10, "saveSettingsLocked - other liveWallpapers - FALSE"
    ...
    const-string v10, "saveSettingsLocked-setSettingsSystemUiTransparency"

    invoke-static {v9, v10}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 1290
    invoke-virtual {p0, v1}, Lcom/android/server/WallpaperManagerService;->setSettingsSystemUiTransparency(I)V

    .line 1292
    .end local v1           #defaultWallpaper:I
    .end local v5           #packageName:Ljava/lang/String;
    .end local v8           #wallpaper_image:Ljava/io/File;
    :cond_2
    return-void
    ...
    .restart local v1       #defaultWallpaper:I
    .restart local v5       #packageName:Ljava/lang/String;
    .restart local v8       #wallpaper_image:Ljava/io/File;
    :cond_4
    :try_start_4
    const-string v9, "WallpaperService"

    const-string v10, "saveSettingsLocked - liveWallpaperSet - TRUE"
    ...
    const-string v10, "saveSettingsLocked - NameNotFoundException"
    ...
    const-string v11, "saveSettingsLocked - imageWallpaper : "
    ...
    const-string v10, "com.sec.android.app.wallpaperchooser"
    ...
    const-string v10, "saveSettingsLocked - wallpaperSet - TRUE"
    ...
    const-string v10, "saveSettingsLocked - other images - FALSE"
    ...
    const-string v10, "saveSettingsLocked - abnormal case - FALSE"
    ...
    const-string v10, "saveSettingsLocked - defaultWallpaper - TRUE"
