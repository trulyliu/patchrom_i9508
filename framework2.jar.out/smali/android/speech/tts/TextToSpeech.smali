...
# instance fields
.field private duringBindingTime:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/speech/tts/TextToSpeech$OnInitListener;Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    iput v0, p0, Landroid/speech/tts/TextToSpeech;->duringBindingTime:I
...
.method static synthetic access$1000(Landroid/speech/tts/TextToSpeech;)I
    .locals 1
    .parameter "x0"

    .prologue
    .line 52
    iget v0, p0, Landroid/speech/tts/TextToSpeech;->duringBindingTime:I

    return v0
.end method

.method static synthetic access$1100(Landroid/speech/tts/TextToSpeech;I)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$1200(Landroid/speech/tts/TextToSpeech;)Landroid/content/Context;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$1300(Landroid/speech/tts/TextToSpeech;)I
    .locals 1
    .parameter "x0"
...
.method private connectToEngine(Ljava/lang/String;)Z
    ...
    invoke-direct {v1, p0, v5}, Landroid/speech/tts/TextToSpeech$Connection;-><init>(Landroid/speech/tts/TextToSpeech;Landroid/speech/tts/TextToSpeech$1;)V

    .line 626
    .local v1, connection:Landroid/speech/tts/TextToSpeech$Connection;
    new-instance v2, Landroid/content/Intent;

    const-string v5, "android.intent.action.TTS_SERVICE"
    ...
    .line 628
    iput v4, p0, Landroid/speech/tts/TextToSpeech;->duringBindingTime:I

    .line 629
    iget-object v5, p0, Landroid/speech/tts/TextToSpeech;->mContext:Landroid/content/Context;

    invoke-virtual {v5, v2, v1, v4}, Landroid/content/Context;->bindService(Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z

    move-result v0

    .line 630
    .local v0, bound:Z
    iput v3, p0, Landroid/speech/tts/TextToSpeech;->duringBindingTime:I
