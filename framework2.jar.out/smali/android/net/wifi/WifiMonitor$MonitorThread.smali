...
.method public run()V
    ...
    #getter for: Landroid/net/wifi/WifiMonitor;->mStateMachine:Lcom/android/internal/util/StateMachine;
    invoke-static {v9}, Landroid/net/wifi/WifiMonitor;->access$000(Landroid/net/wifi/WifiMonitor;)Lcom/android/internal/util/StateMachine;
    ...
    #getter for: Landroid/net/wifi/WifiMonitor;->mWifiNative:Landroid/net/wifi/WifiNative;
    invoke-static {v9}, Landroid/net/wifi/WifiMonitor;->access$100(Landroid/net/wifi/WifiMonitor;)Landroid/net/wifi/WifiNative;

    move-result-object v9

    invoke-virtual {v9}, Landroid/net/wifi/WifiNative;->waitForEvent()Ljava/lang/String;
    ...
    const-string v9, "certificate initialization failed"
    ...
    .line 545
    .restart local v5       #eventStr:Ljava/lang/String;
    :cond_2
    const-string v9, "WAPI:"
    ...
    const-string v9, "authentication failed"
    ...
    invoke-virtual {v9, v5, v10}, Landroid/net/wifi/WifiMonitor;->notifyAuthenticationFailure(Ljava/lang/String;Z)V
    ...
    .line 565
    :cond_7
    const-string v9, "WPS-OVERLAP-DETECTED"
    ...
    .line 573
    :cond_b
    const-string v9, "CTRL-REQ-IDENTITY"
    ...
    invoke-virtual {v9, v10, v11}, Landroid/net/wifi/WifiMonitor;->notifyAuthenticationFailure(Ljava/lang/String;Z)V
    ...
    .line 579
    invoke-direct {p0, v5}, Landroid/net/wifi/WifiMonitor$MonitorThread;->handleHS20Events(Ljava/lang/String;)V

    goto/16 :goto_0

    .line 582
    :cond_e
    const-string v9, "REQ-PASSPHRASE"
    ...
    .line 586
    :cond_f
    const-string v9, "KT-NOTIFICATION"
    ...
    .line 593
    :cond_10
    const-string v9, "CTRL-EVENT-EAP-TLS-CERT-ERROR"
    ...
    invoke-virtual {v0, v9, v5, v10}, Landroid/sec/enterprise/certificate/CertificatePolicy;->notifyCertificateFailure(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    #getter for: Landroid/net/wifi/WifiMonitor;->mEapMethod:Ljava/lang/String;
    invoke-static {v9}, Landroid/net/wifi/WifiMonitor;->access$400(Landroid/net/wifi/WifiMonitor;)Ljava/lang/String;
    ...
    .line 660
    :cond_13
    const-string v9, "ACTION-FRAME-VS-WES"
    ...
    invoke-static {v9, v10}, Landroid/net/wifi/WifiMonitor;->access$502(Landroid/net/wifi/WifiMonitor;I)I
    ...
    .end local v2           #event:I
    :cond_24
    const-string v9, "CTRL-EVENT-SCC-DIFF-FREQ"
    ...
    invoke-static {v9}, Landroid/net/wifi/WifiMonitor;->access$504(Landroid/net/wifi/WifiMonitor;)I
