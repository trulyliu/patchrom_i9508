...
.method private displayNotification()V
    ...
    invoke-static {v2}, Landroid/net/wifi/WifiWatchdogStateMachine$RttResultHandler;->access$5100(Landroid/net/wifi/WifiWatchdogStateMachine$RttResultHandler;)Ljava/lang/String;
    ...
    invoke-static {v2}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$3100(Landroid/net/wifi/WifiWatchdogStateMachine;)Landroid/content/Context;
    ...
    invoke-static {v2}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$5300(Landroid/net/wifi/WifiWatchdogStateMachine;)Landroid/app/NotificationManager;
    ...
    invoke-static {v3, v2}, Landroid/net/wifi/WifiWatchdogStateMachine;->access$5302(Landroid/net/wifi/WifiWatchdogStateMachine;Landroid/app/NotificationManager;)Landroid/app/NotificationManager;
...
.method public writeResults()V
    ...
    #getter for: Landroid/net/wifi/WifiWatchdogStateMachine$RttResultHandler;->TAG:Ljava/lang/String;
    invoke-static {v6}, Landroid/net/wifi/WifiWatchdogStateMachine$RttResultHandler;->access$5100(Landroid/net/wifi/WifiWatchdogStateMachine$RttResultHandler;)Ljava/lang/String;
    ...
    invoke-static {v7}, Landroid/net/wifi/WifiWatchdogStateMachine$RttResultHandler;->access$5200(Landroid/net/wifi/WifiWatchdogStateMachine$RttResultHandler;)Ljava/text/SimpleDateFormat;
    ...
    #getter for: Landroid/net/wifi/WifiWatchdogStateMachine$RttResultHandler;->TAG:Ljava/lang/String;
    invoke-static {v7}, Landroid/net/wifi/WifiWatchdogStateMachine$RttResultHandler;->access$5100(Landroid/net/wifi/WifiWatchdogStateMachine$RttResultHandler;)Ljava/lang/String;
