...
.method private doScan()V
    ...
    iget v3, v3, Lcom/android/server/FMRadioService;->mBand:I
    ...
    invoke-static {v3}, Lcom/android/server/FMRadioService;->access$1100(Lcom/android/server/FMRadioService;)Z
    ...
    invoke-static {v3}, Lcom/android/server/FMRadioService;->access$2900(Lcom/android/server/FMRadioService;)Ljava/util/ArrayList;
    ...
    invoke-static {v3, v0, v1}, Lcom/android/server/FMRadioService;->access$1302(Lcom/android/server/FMRadioService;J)J
    ...
    #getter for: Lcom/android/server/FMRadioService;->mScanChannelList:Ljava/util/ArrayList;
    invoke-static {v4}, Lcom/android/server/FMRadioService;->access$2900(Lcom/android/server/FMRadioService;)Ljava/util/ArrayList;
    ...
    invoke-static {v4}, Lcom/android/server/FMRadioService;->access$3000(Lcom/android/server/FMRadioService;)Z
    ...
    #getter for: Lcom/android/server/FMRadioService;->mIsSkipTunigVal:Z
    invoke-static {v3}, Lcom/android/server/FMRadioService;->access$3000(Lcom/android/server/FMRadioService;)Z
    ...
    invoke-static {v3, v7, v6, v6}, Lcom/android/server/FMRadioService;->access$3100(Lcom/android/server/FMRadioService;III)V
...
.method public run()V
    ...
    invoke-static {v3, v4}, Lcom/android/server/FMRadioService;->access$3202(Lcom/android/server/FMRadioService;I)I

    .line 2755
    iget-object v3, p0, Lcom/android/server/FMRadioService$ScanThread;->this$0:Lcom/android/server/FMRadioService;

    #getter for: Lcom/android/server/FMRadioService;->mPowerManager:Landroid/os/PowerManager;
    invoke-static {v3}, Lcom/android/server/FMRadioService;->access$3300(Lcom/android/server/FMRadioService;)Landroid/os/PowerManager;
    ...
    #setter for: Lcom/android/server/FMRadioService;->mScanFreq:J
    invoke-static {v3, v4, v5}, Lcom/android/server/FMRadioService;->access$1302(Lcom/android/server/FMRadioService;J)J
    ...
    invoke-static {v3, v4}, Lcom/android/server/FMRadioService;->access$2902(Lcom/android/server/FMRadioService;Ljava/util/ArrayList;)Ljava/util/ArrayList;
    ...
    invoke-static {v4}, Lcom/android/server/FMRadioService;->access$3400(Lcom/android/server/FMRadioService;)I
    ...
    invoke-static {v6}, Lcom/android/server/FMRadioService;->access$3600(Lcom/android/server/FMRadioService;)I

    move-result v6

    #calls: Lcom/android/server/FMRadioService;->setSignalSetting(III)V
    invoke-static {v3, v4, v5, v6}, Lcom/android/server/FMRadioService;->access$3100(Lcom/android/server/FMRadioService;III)V
    ...
    invoke-static {v3, v7}, Lcom/android/server/FMRadioService;->access$1102(Lcom/android/server/FMRadioService;Z)Z
    ...
    #setter for: Lcom/android/server/FMRadioService;->mScanProgress:Z
    invoke-static {v4, v7}, Lcom/android/server/FMRadioService;->access$1102(Lcom/android/server/FMRadioService;Z)Z
