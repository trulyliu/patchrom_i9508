...
.method private calculateEllipsis(II[FIFLandroid/text/TextUtils$TruncateAt;IFLandroid/text/TextPaint;Z)V
    ...
    .line 881
    :cond_0
    sget-object v21, Landroid/text/TextUtils$TruncateAt;->END_SMALL:Landroid/text/TextUtils$TruncateAt;
    ...
    sget-object v21, Landroid/text/StaticLayout;->ELLIPSIS_TWO_DOTS:[C
    ...
    .line 889
    .local v10, len:I
    sget-object v21, Landroid/text/TextUtils$TruncateAt;->START:Landroid/text/TextUtils$TruncateAt;
    ...
    const-string v22, "CscFeature_Framework_EnableEmoji"
    ...
    .end local v10           #len:I
    :cond_3
    sget-object v21, Landroid/text/StaticLayout;->ELLIPSIS_NORMAL:[C
    ...
    .line 902
    .local v20, w:F
    add-float v21, v20, v17

    add-float v21, v21, v6

    cmpl-float v21, v21, p5
    ...
    const-string v22, "Start Ellipsis only supported with one line"
    ...
    aget-char v21, v18, v7

    invoke-static/range {v21 .. v21}, Landroid/text/TextUtils;->isArabicChar(C)Z
    ...
    cmpg-float v21, v21, p5

    if-gtz v21, :cond_c

    .line 947
    .end local v16           #s:Ljava/lang/String;
    .end local v19           #tmpwid:F
    :cond_a
    move v5, v7
    ...
    .restart local v18       #tmpBuf:[C
    .restart local v19       #tmpwid:F
    :cond_c
    add-int/lit8 v7, v7, -0x1
    ...
    const-string v22, "Middle Ellipsis only supported with one line"
