...
.field public static final DATA_ROAMING_SECONDARY:Ljava/lang/String; = "data_roaming_1"
...
.field public static final DB_KIDS_MODE:Ljava/lang/String; = "kids_mode_enabled"
...
.field public static final DEFAULT_TORCHLIGHT_ENABLE_URI:Landroid/net/Uri; = null

.field public static final DEFAULT_TORCHLIGHT_TIMEOUT_URI:Landroid/net/Uri; = null
...
.field public static final SAMBA_ON:Ljava/lang/String; = "samba_on"
...
.method static constructor <clinit>()V
    ...
    sput-object v1, Landroid/provider/Settings$System;->CONTENT_URI:Landroid/net/Uri;
    ...
    invoke-direct {v1, v2, v3, v4, v5}, Landroid/provider/Settings$NameValueCache;-><init>(Ljava/lang/String;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)V
    ...
    sput-object v1, Landroid/provider/Settings$System;->MOVED_TO_SECURE:Ljava/util/HashSet;
    ...
    const-string/jumbo v2, "wifi_defaultap_profile"
    ...
    const-string/jumbo v2, "wifi_generalinfo_nwinfo"
    ...
    sput-object v1, Landroid/provider/Settings$System;->MOVED_TO_GLOBAL:Ljava/util/HashSet;
    ...
    sput-object v1, Landroid/provider/Settings$System;->MOVED_TO_SECURE_THEN_GLOBAL:Ljava/util/HashSet;
    ...
    const-string/jumbo v3, "volume_bluetooth_sco"

    aput-object v3, v1, v2

    const/4 v2, 0x7

    const-string/jumbo v3, "volume_enforced"
    ...
    const-string/jumbo v3, "volume_fm"

    aput-object v3, v1, v2

    sput-object v1, Landroid/provider/Settings$System;->VOLUME_SETTINGS:[Ljava/lang/String;
    ...
    sput-object v1, Landroid/provider/Settings$System;->DEFAULT_RINGTONE_URI:Landroid/net/Uri;
    ...
    sput-object v1, Landroid/provider/Settings$System;->DEFAULT_RINGTONE_URI_2:Landroid/net/Uri;
    ...
    sput-object v1, Landroid/provider/Settings$System;->DEFAULT_NOTIFICATION_URI:Landroid/net/Uri;
    ...
    sput-object v1, Landroid/provider/Settings$System;->DEFAULT_NOTIFICATION_URI_2:Landroid/net/Uri;
    ...
    sput-object v1, Landroid/provider/Settings$System;->DEFAULT_ALARM_ALERT_URI:Landroid/net/Uri;
    ...
    sput-object v1, Landroid/provider/Settings$System;->DEFAULT_TORCHLIGHT_ENABLE_URI:Landroid/net/Uri;

    .line 2230
    const-string/jumbo v1, "torchlight_timeout"

    invoke-static {v1}, Landroid/provider/Settings$System;->getUriFor(Ljava/lang/String;)Landroid/net/Uri;

    move-result-object v1

    sput-object v1, Landroid/provider/Settings$System;->DEFAULT_TORCHLIGHT_TIMEOUT_URI:Landroid/net/Uri;
    ...
    const-string/jumbo v3, "wifi_static_use_wagip"

    aput-object v3, v1, v2

    const/16 v2, 0x8

    const-string/jumbo v3, "wifi_static_wagip"

    aput-object v3, v1, v2

    const/16 v2, 0x9

    const-string/jumbo v3, "wifi_static_wagport"

    aput-object v3, v1, v2

    const/16 v2, 0xa

    const-string/jumbo v3, "wifi_static_wagfqdn"
    ...
    const-string/jumbo v3, "volume_voice_last_audible"

    aput-object v3, v1, v2

    const/16 v2, 0x1f

    const-string/jumbo v3, "volume_system_last_audible"

    aput-object v3, v1, v2

    const/16 v2, 0x20

    const-string/jumbo v3, "volume_ring_last_audible"

    aput-object v3, v1, v2

    const/16 v2, 0x21

    const-string/jumbo v3, "volume_music_last_audible"

    aput-object v3, v1, v2

    const/16 v2, 0x22

    const-string/jumbo v3, "volume_alarm_last_audible"

    aput-object v3, v1, v2

    const/16 v2, 0x23

    const-string/jumbo v3, "volume_notification_last_audible"

    aput-object v3, v1, v2

    const/16 v2, 0x24

    const-string/jumbo v3, "volume_bluetooth_sco_last_audible"
    ...
    sput-object v1, Landroid/provider/Settings$System;->SETTINGS_TO_BACKUP:[Ljava/lang/String;
